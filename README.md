...
> - `$city` - 城市名/[高德地址位置 adcode](https://lbs.amap.com/api/webservice/guide/api/district)，比如：“无锡” 或者（adcode：440300）；
...
可以用两种方式来获取 `hdliyu\Weather\Weather` 实例：
